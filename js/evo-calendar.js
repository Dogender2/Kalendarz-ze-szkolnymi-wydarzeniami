            ...
            _.initials = {
                ...
                dates: {
                    en: {
                        ...
                        daysShort: ["Niedz.", "Pon.", "Wt.", "Śro.", "Czw.", "Pt.", "Sob."],
                        daysMin: ["N", "Pn", "Wt", "Śr", "Cz", "Pt", "So"],
                        months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
                        monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
                        noEventForToday: "Brak wydarzeń na dziś! :)",
                        noEventForThisDay: "Brak wydarzeń dla tego dnia! :)",
                        previousYearText: "Wcześniejszy rok",
                        nextYearText: "Następny rok",
                        closeSidebarText: "Zamknij panel boczny",
